function getButtons(){
	...
	$('.buttons .button.Contrast').click(function(){
		if($(this).hasClass('active')){
			$(this).removeClass('active');
			$('#content #inhalt .opacityScrollable .items img').removeClass('contrast');
			$('#content #inhalt .scrollable .items img').removeClass('contrast');
	...
	$('.buttons .button.Zoom-p-h').mousedown(function(e) {
	    ...
	    this.downTimer = setTimeout(function() {
	    	timerId = setInterval(function(){
	    		...
	    		$('#complete_content #content #inhalt .path').toggleClass('zoomed-p-h');
	    	},800);
	    ...
	    if(press === true){
	    	...
	    	$('#complete_content #content #inhalt .path').removeClass('zoomed-p-h');
	    	press = false;
	    }
	});
	...
	$('.buttons .button.Vibe').on('mousedown touchstart',function(e) {
	    ...
	    this.downTimer = setTimeout(function() {
	    	timerId = setInterval(function(){
	    		...
	    		$('#complete_content #content #inhalt .path').toggleClass('vibe');
	    	},100);
	    ...
	    if(press === true){
	    	...
	    	$('#complete_content #content #inhalt .path').removeClass('vibe');
	    	press = false;
	    }
	});
	...
	$('.buttons .button.Drop').click(function() {
		...
		setTimeout(function(){
		   $('.buttons .button.Drop').removeClass('active');
		   $('#content #inhalt .overlay').removeClass('dropped').css('z-index', 0);
		},4000);
	});

	$('.szene9Scrollable.szene9 .items .opacity0, .szene9Scrollable.szene9 .items .opacity1, .szene9Scrollable.szene9 .items .opacity2').css('opacity', 0);
	
	// $('.szene9Scrollable.szene9 .items').first().addClass('active');
