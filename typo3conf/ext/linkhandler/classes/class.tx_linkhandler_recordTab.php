...
class tx_linkhandler_recordTab implements tx_linkhandler_tabHandler {
	...
	public function getTabContent() {
		...
		if (t3lib_div::_GET("selectedPage")) $selectedPage = t3lib_div::_GET("selectedPage");
		
		$content .= '
		<div style="margin-top:-15px;">Seiten-ID: <input type="text" name="lhSelectedPage" id="lhSelectedPage" value="'.$selectedPage.'" style="width:40px;" /></div>
		<script type="text/javascript">
		function setPage(uid) {
			$("lhSelectedPage").value = uid;
		}			
		function getPID() {
			param = "";
			if ($("lhSelectedPage").value) {
				param = \'&selectedPage=\'+$("lhSelectedPage").value;
			}
			return param;
		}
		</script>';
