...
$TCA['tt_address'] = array (
	...
	'columns' => array (
		...
		'gender' => array (
			...
			'config' => array (
				...
				'default' => '0',
				'items'   => array(
					array('LLL:EXT:tt_address/locallang_tca.xml:tt_address.gender.m', '1'),
					array('LLL:EXT:tt_address/locallang_tca.xml:tt_address.gender.f', '2')
				)
			)
		),
		'name' => array (
		...
		"requests" => Array (
			"label" => utf8_encode("Anfragen"),
			"config" => Array (
				"type" => "inline",
				"size" => 6,
				"maxitems" => 100,
				"foreign_table" => "tx_requests",
		...
		"newsletter" => Array (
			"label" => utf8_encode("Newsletter"),
			"config" => Array (
				"type" => "select",
				"items" => array(
					array('Kein Newsletter', 0),
					array(utf8_encode('unbestätigt'), 1),
					array(utf8_encode('Newsletter'), 2),
					array(utf8_encode('abgemeldet'), -1),
				)
			)
		),
	...
	'types' => array (
		'1' => array('showitem' => 'hidden;;;;1-1-1, gender;;5;;3-3-3, name;;2, email;;5,newsletter,requests,--div--;Details, birthday,address, zip, city;;3, phone;;4, description, www')
	),
	'palettes' => array (
		'2' => array('showitem' => 'title, company'),
		'3' => array('showitem' => 'country, region'),
		'4' => array('showitem' => 'mobile, fax'),
		'5' => array('showitem' => 'salutation'),
...
$showItemReplace = ' name, first_name,  last_name;;2;;,';
...
if($extConf['disableCombinedNameField']) {
	...
	$showItemReplace            = ' first_name, last_name;;2;;,';
